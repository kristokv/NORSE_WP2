...
```{r fig_months_years, fig.cap="Distribution of observations from all sites over time. Size of the points indicate the number of months sampled that year, with color indicating which month.", fig.height=8, fig.width=10}

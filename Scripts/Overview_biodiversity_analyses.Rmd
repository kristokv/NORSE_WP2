...
perm_epi <- adonis2(dists ~ as.factor(Country) + as.factor(salinity_factor), data = dat_w, permutations=9999, by ="terms")
print(perm_epi)
...
NMDS1<-ord.epifauna$points[,1]
NMDS2<-ord.epifauna$points[,2]

#jpeg("../Graphs/MNDS_epifauna_genera.jpg", width=190, height=140,units="mm",res=300)
plot(ord.epifauna, type="n")
ordiellipse(ord.epifauna, dat_w$Country, draw="polygon",label=FALSE, col = cols_countries, lty =0)
orditorp(ord.epifauna, type="n" ,display="sites",cex=0.5)
legend("bottomright", legend = countries, col = cols_countries, pch = 19, bty = "n")
ordiellipse(ord.epifauna, dat_w$salinity_factor, draw="polygon",label=TRUE, lty =1:3,col="lightgrey",alpha=0.5, cex = 0.8) 
...
dists <-vegdist(comm_mat)
ord.infauna <- metaMDS(dists, trymax = 100)
print(ord.infauna)
...
#jpeg("../Graphs/MNDS_infauna_genera.jpg", width=190, height=140,units="mm",res=300)
plot(ord.infauna, type="n")
ordiellipse(ord.infauna, dat_w$Country, draw="polygon",label=FALSE, col = cols_countries, lty =0)
orditorp(ord.infauna, display="sites",cex=0.7)
legend("bottomright", legend = countries, col = cols_countries, pch = 19, bty = "n")
ordiellipse(ord.infauna, dat_w$salinity_factor, draw="polygon",label=TRUE, lty =1:3,col="lightgrey",alpha=0.5)
